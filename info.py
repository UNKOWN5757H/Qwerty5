...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '0')) # Fixed: Default to '0'
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '')).split() if ch] # Fixed: Added 'if ch' to skip empty strings
